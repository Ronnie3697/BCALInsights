...
**Zdroj pravdy:** `ew-mobile-ui-notes.md` ve stejném adresáři jako tenhle `SKILL.md`
...
1. **Přečti `ew-mobile-ui-notes.md` z adresáře tohoto skillu celý.** Vejde se do jednoho Read;
