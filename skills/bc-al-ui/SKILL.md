...
**Zdroj pravdy:** `C:\WorkTasks\BCALInsights\bc-al-ui.md`
(v repu `../../bc-al-ui.md` relativně k tomuto skillu). Tenhle skill je jen wrapper —
...
1. **Přečti `C:\WorkTasks\BCALInsights\bc-al-ui.md` celý.** Vejde se do jednoho Read; když se
